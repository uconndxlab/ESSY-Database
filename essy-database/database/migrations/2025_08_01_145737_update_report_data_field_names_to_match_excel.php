...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // O_P_HYGIENE_CL2 needs to be migrated to O_P_hygiene_CL2 (Excel spelling)
        DB::statement('UPDATE report_data SET O_P_hygiene_CL2 = O_P_HYGIENE_CL2 WHERE O_P_HYGIENE_CL2 IS NOT NULL');
