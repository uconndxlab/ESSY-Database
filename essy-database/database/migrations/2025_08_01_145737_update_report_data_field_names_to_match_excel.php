...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('report_data', function (Blueprint $table) {
            ...
            // O_P_HYGEINE_CL1 already exists in initial migration with correct spelling
            $table->string('O_P_HYGEINE_CL2')->nullable();
        ...
        // O_P_HYGEINE_CL1 already has correct spelling in initial migration
        // O_P_HYGIENE_CL2 needs to be migrated to O_P_HYGEINE_CL2 (Excel spelling)
        DB::statement('UPDATE report_data SET O_P_HYGEINE_CL2 = O_P_HYGIENE_CL2 WHERE O_P_HYGIENE_CL2 IS NOT NULL');
        ...
        Schema::table('report_data', function (Blueprint $table) {
            $table->dropColumn([
                ...
                'O_P_HYGIENE_CL2', // This exists and needs to be dropped
                'S_COMMCONN'
            ]);
        });
    }
    ...
    public function down(): void
    {
        Schema::table('report_data', function (Blueprint $table) {
            ...
            // Don't re-add O_P_HYGIENE_CL1 as it never existed (initial migration has O_P_HYGEINE_CL1)
        ...
        // O_P_HYGEINE_CL1 stays as is (correct spelling from initial migration)
        DB::statement('UPDATE report_data SET O_P_HYGIENE_CL2 = O_P_HYGEINE_CL2 WHERE O_P_HYGEINE_CL2 IS NOT NULL');
        DB::statement('UPDATE report_data SET S_COMMCONN = S_O_COMMCONN_CL1 WHERE S_O_COMMCONN_CL1 IS NOT NULL');

        // Drop new field names (except O_P_HYGEINE_CL1 which existed in initial migration)
        Schema::table('report_data', function (Blueprint $table) {
            $table->dropColumn([
                ...
                'P_ORAL',
                'P_PHYS',
                // Don't drop O_P_HYGEINE_CL1 as it existed in initial migration
                'O_P_HYGEINE_CL2',
                'S_O_COMMCONN_CL1',
                'S_O_COMMCONN_CL2'
            ]);
